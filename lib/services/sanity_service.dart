...
class SanityService {
  ...
  Future<List<Product>> fetchProductsByCategory(String categoryId) async {
    try {
      ...
      return _getMockProducts().where((p) => p.categoryId == categoryId || p.categoryId == 'mock-cat-1').toList();
    }
  }
  ...
  List<Product> _getMockProducts() {
    return [
      ...
      Product(
        ...
        price: 49.99,
        imageUrl: 'https://images.unsplash.com/photo-1542272617-08f08630329e?auto=format&fit=crop&w=800&q=80',
        categoryId: 'mock-cat-2',
        stockStatus: 'inStock',
      ),
    ];
    ...
    return [
      ...
      Category(
       ...
       Category(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1523293188086-b51292955d2c?auto=format&fit=crop&w=800&q=80',
      ),
    ];
  }
}
